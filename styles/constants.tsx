export const STYLE_DARK_MODE = {
	...
	lineColor: "#2F2F2F",
	backdropProgressBar: "rgba(250, 250, 250, .1)",
	buttonColor: "#1A1A1B",
	buttonColorBorder: "#2F2F2F",
...
export const STYLE_LIGHT_MODE = {
	...
	lineColor: "#ececec",
	backdropProgressBar: "rgba(18, 18, 18, .1)",
	buttonColor: "#ffffff",
	buttonColorBorder: "#ececec",
...
export const SIZES = {
	...
	introDashboardHeader: "clamp(1rem, 0.7857rem + 1.0714vw, 1.75rem)",
	introDashboardDate: "clamp(0.75rem, 0.1346rem + 0.9615vw, 1rem)",
	buttonFontSize: "12px",
